 ...
 */
const madListOfText = [
  'Мобильное приложение "Менеджер рейсов" является незаменимым инструментом для водителей и транспортных компаний, помогающим собирать и анализировать основные статистические данные о пробеге, маршрутах, остановках и других параметрах, связанных с логистикой.',
  'Это обеспечивает повышение эффективности, оптимизацию операций и улучшение общей производительности для транспортных компаний, делая "Менеджер рейсов" лучшим выбором для современного транспортного бизнеса.'
 ];
